...
[![Bindgen SDL_shadercross](https://github.com/AerafalDev/Jade/actions/workflows/bindgen-sdl_shadercross.yml/badge.svg)](https://github.com/AerafalDev/Jade/actions/workflows/bindgen-sdl_shadercross.yml)
...
|---|---|---|---:|:---:|
| Windows | `win-x64` | Native | x64 | ✅ |
| Windows | `win-arm64` | Native | ARM64 | ✅ |
| macOS | `osx-x64` | Native | x64 | ✅ |
| macOS | `osx-arm64` | Native | ARM64 | ✅ |
| Linux | `linux-x64` | Native | x64 | ✅ |
| Linux | `linux-arm64` | Native | ARM64 | ✅ |
| Browser | `browser-wasm` | WebAssembly | WASM | ✅ |
